...
getgenv().GWEBHOOK_USERID = "829343564320210965"
getgenv().GWEBHOOK_LINK = "https://discord.com/api/webhooks/1067146472463802388/RirvRrzdbaud-W9ycVlutkz4eYf843A23v_6pnHBi8TdPecxQABMEtGKSpbERoheRvhm"
getgenv().GMAIL_RECEIVERS = {"Cam3ronD3an2006"} -- for Huges and mailrules.
getgenv().GMAIL_ITEMS = {
